export default function AddButton({ isLoading }: { isLoading: boolean }) {
    return (
        <button
            className={`h-10 w-12 flex items-center justify-center text-4xl rounded-xl ${
        ...
        >
            {isLoading ? (
                <div
                    className="flex w-5 h-5 flex-col items-center gap-2"
                    role="status"
                >
                    <svg
                        aria-hidden="true"
                        className="w-full h-full text-gray-200 animate-spin dark:text-gray-600 fill-purple-400"
                        viewBox="0 0 100 101"
                        fill="none"
